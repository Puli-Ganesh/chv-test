...
const API_BASE = "https://chv-test-backend.vercel.app";
...
function AdminDashboard() {
  ...
  async function handleFileUpload(e) {
    ...
    if (res.ok) {
      ...
      const err = await res.json().catch(() => ({}));
      notify(err.error || "Upload failed");
    }
    e.target.value = "";
  }
  ...
  function clearEmployeeData() {
    setExcelData([]);
    notify("Data cleared (frontend view)");
  }
            ...
            <div className="a-alloc">
              <div className="a-alloc-row">
                ...
                <div className="a-value">
                  {selectedUser
                    ? employees.find((e) => e.id === selectedUser)?.username || selectedUser
                    : "-"}
                </div>
              </div>
